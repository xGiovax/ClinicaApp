...
namespace ClinicaApp.Controllers
{
    public class CitasController : Controller
    {
        ...
        {
            var clinicaDbContext = _context.Citas.Include(c => c.Paciente);
        ...
        public async Task<IActionResult> Create([Bind("Id,Fecha,Motivo,PacienteId")] Cita cita)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Fecha,Motivo,PacienteId")] Cita cita)
        {
            if (id != cita.Id)
            {
                return NotFound();
